...
String adminKey;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this) .asGif() .load(R.raw.grp)
                .into(gifImageView);
...
String adminKey=sharedPreferences.getString("group_admin_key",null);
       ...
       //String adminKey=sharedPreferences.getString("admin", null);
       String aa="Posts_" + groupName + "_" + adminKey;



        databaseReference = FirebaseDatabase.getInstance()
                .getReference("ProfileInfo").child(institution).child(aa);
...
//            String formattedDate = sdf.format(new Date(timestamp));  // Convert timestamp to human-readable format
