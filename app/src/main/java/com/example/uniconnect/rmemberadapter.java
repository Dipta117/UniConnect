...
public class rmemberadapter extends RecyclerView.Adapter<rmemberadapter.ViewHolder> {
    private Context context;
    private List<Member> members;
    private Map<String, Boolean> attendanceMap;

    public rmemberadapter(Context context, List<Member> members, Map<String, Boolean> attendanceMap) {
